...
public class RocketPanel extends JPanel {
    public static int totalAmountOfRocket = 100000;
    ...
    public RocketPanel(){
        ...
        lblBkashTitle = new JLabel("Rocket");
        ...
        AddingButtonPanel.paymentMethodAddingButton.addActionListener(e -> {
            try{
                ...
                String query = "insert into public.rocket_transaction_info values(?,?,?,?,?)";
                ...
                if (amount < 50000 && amount >= 500) {
                    ...
                    totalAmountOfRocket = totalAmountOfRocket - amount;
                } else {
                ...
                stmt.executeUpdate();
                JOptionPane.showMessageDialog(null,"Rocket Transaction Successfully");


                toMobile= RocketPanel.txtMobileNumber.getText();
                transaction_id=RocketPanel.txtTransactionID.getText();
                issue_date=RocketPanel.bKashIssueDate.getDate().toString();
                lastAmount= String.valueOf(Integer.parseInt(RocketPanel.txtAmount.getText()));
