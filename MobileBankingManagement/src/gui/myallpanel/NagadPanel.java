...
public class NagadPanel extends JPanel {
    public static int totalAmountOfNagad = 100000;
    ...
    public NagadPanel(){
        ...
        lblBkashTitle = new JLabel("Nagad");
        ...
        AddingButtonPanel.paymentMethodAddingButton.addActionListener(e -> {
            try{
                ...
                String query = "insert into public.nagad_transaction_info values(?,?,?,?,?)";
                ...
                if (amount < 50000 && amount >= 500) {
                    ...
                    totalAmountOfNagad = totalAmountOfNagad-amount;
                } else {
                ...
                stmt.executeUpdate();
                JOptionPane.showMessageDialog(null," Nagad Transaction Successfully");


                toMobile= NagadPanel.txtMobileNumber.getText();
                transaction_id=NagadPanel.txtTransactionID.getText();
                issue_date=NagadPanel.bKashIssueDate.getDate().toString();
                lastAmount= String.valueOf(Integer.parseInt(NagadPanel.txtAmount.getText()));
