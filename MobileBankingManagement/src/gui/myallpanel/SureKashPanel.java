...
public class SureKashPanel extends JPanel {
    public static int totalAmountOfSureKash = 100000;
    ...
    public SureKashPanel(){
        setLayout(null);
        setBackground(Color.cyan);
        setBounds(0,152,600,300);

        lblBkashTitle = new JLabel("sure kash");
        ...
        AddingButtonPanel.paymentMethodAddingButton.addActionListener(e -> {
            try{
                ...
                String query = "insert into public.surekash_transaction_info values(?,?,?,?,?)";
                ...
                if (amount < 50000 && amount >= 500) {
                    ...
                    totalAmountOfSureKash = totalAmountOfSureKash - amount;
                } else {
                ...
                stmt.executeUpdate();
                JOptionPane.showMessageDialog(null,"Sure Kash Transaction Successfully");


                toMobile= SureKashPanel.txtMobileNumber.getText();
                transaction_id=SureKashPanel.txtTransactionID.getText();
                issue_date=SureKashPanel.bKashIssueDate.getDate().toString();
                lastAmount= String.valueOf(Integer.parseInt(SureKashPanel.txtAmount.getText()));
