...
import gui.myallpanel.NagadPanel;

import javax.swing.*;
import javax.swing.table.DefaultTableModel;
import java.awt.*;

public class LastTransactionFrameForNagad extends JFrame{
    JLabel titleBar;

    JPanel panelPaymentDashboard;

    public LastTransactionFrameForNagad(){
        ...
        titleBar = new JLabel();
        titleBar.setText("Your Nagad Last Transaction Info");
        titleBar.setFont(new Font("Serif",Font.BOLD,20));
        titleBar.setForeground(Color.red);
        titleBar.setBounds(60,20,350,30);

        DefaultTableModel model = new DefaultTableModel(new String[][] { { NagadPanel.toMobile, NagadPanel.transaction_id, NagadPanel.issue_date, NagadPanel.lastAmount}}, new String[] { "To Mobile","Transaction ID","Date","Amount"} );
