...
import gui.myallpanel.RocketPanel;

import javax.swing.*;
import javax.swing.table.DefaultTableModel;
import java.awt.*;

public class LastTransactionFrameForRocket extends JFrame{
    JLabel titleBar;

    JPanel panelPaymentDashboard;

    public LastTransactionFrameForRocket(){
        ...
        titleBar = new JLabel();
        titleBar.setText("Your Rocket Last Transaction Info");
        titleBar.setFont(new Font("Serif",Font.BOLD,20));
        titleBar.setForeground(Color.red);
        titleBar.setBounds(60,20,350,30);

        DefaultTableModel model = new DefaultTableModel(new String[][] { { RocketPanel.toMobile, RocketPanel.transaction_id, RocketPanel.issue_date, RocketPanel.lastAmount}}, new String[] { "To Mobile","Transaction ID","Date","Amount"} );
